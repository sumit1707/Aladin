      ...
      <div className="bg-gradient-to-br from-emerald-900/95 to-black/95 border-2 border-emerald-500 rounded-xl shadow-2xl shadow-emerald-500/30 max-w-md w-full p-3 relative my-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="bg-black/40 border border-emerald-500/30 rounded-lg p-2">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                <span className="text-emerald-300 text-xs">Hotels</span>
                <div className="flex items-center gap-1.5">
                  <button
                    type="button"
                  ...
                  <span className="text-emerald-400 font-semibold w-5 text-center text-xs">{formData.numberOfHotels}</span>
                  <button
                    type="button"
                    onClick={() => updateNumber('numberOfHotels', 1)}
                    className="w-6 h-6 bg-emerald-600 hover:bg-emerald-700 text-white rounded transition-colors text-xs"
              ...
              <div className="flex items-center justify-between">
                <span className="text-emerald-300 text-xs">Rooms</span>
                <div className="flex items-center gap-1.5">
                  <button
                    type="button"
                  ...
                  <span className="text-emerald-400 font-semibold w-5 text-center text-xs">{formData.numberOfRooms}</span>
                  <button
                    type="button"
                    onClick={() => updateNumber('numberOfRooms', 1)}
                    className="w-6 h-6 bg-emerald-600 hover:bg-emerald-700 text-white rounded transition-colors text-xs"
              ...
              <div className="flex items-center justify-between">
                <span className="text-emerald-300 text-xs">Cars</span>
                <div className="flex items-center gap-1.5">
                  <button
                    type="button"
                  ...
                  <span className="text-emerald-400 font-semibold w-5 text-center text-xs">{formData.numberOfCars}</span>
                  <button
                    type="button"
                    onClick={() => updateNumber('numberOfCars', 1)}
                    className="w-6 h-6 bg-emerald-600 hover:bg-emerald-700 text-white rounded transition-colors text-xs"
